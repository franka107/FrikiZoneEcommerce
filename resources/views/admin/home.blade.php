...
@section('content')
    ...
    <div class="container text-center">
        <div class="row">
            <div class="col-md-6">   
                <img class="img-fluid" src=" {{ asset('images/icon/log.gif') }} ">
            </div>
            <div class="col-md-6"  >
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card text-center">
                    <div class="card-body">
                      <img class="img-fluid" src=" {{ asset('images/icon/cat.png') }} ">
                    </div>
                    <div class="">   
            ...
            <div class="col-md-6">
                <div class="card text-center">
                    <div class="card-body">
                        <img class="img-fluid" src=" {{ asset('images/icon/car.png') }} ">
                    </div>
                    <div>    
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card text-center">
                    <div class="card-body">
                        <img class="img-fluid" src=" {{ asset('images/icon/paypal.png') }} ">   
                    </div>
                    <div>
            ...
            <div class="col-md-6">
                <div class="card text-center">
                    <div class="card-body">
                        <img class="img-fluid" src=" {{ asset('images/icon/users.png') }} ">
                    </div>
                    <div>
